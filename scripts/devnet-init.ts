...
// Re-deploy 2026-06: fresh program IDs under deployer J1GMec (the 4gAdo7R
// admin key was lost; this is a clean re-deployment we fully control).
const PROGRAM_IDS = {
